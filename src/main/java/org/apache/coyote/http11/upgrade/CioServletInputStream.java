...
public class CioServletInputStream extends AbstractServletInputStream {

    private final InputStream inputStream;
    private ByteBuffer leftoverInput;

    public CioServletInputStream(SocketWrapper<CoSocket> wrapper, ByteBuffer leftoverInput)
            throws IOException {
